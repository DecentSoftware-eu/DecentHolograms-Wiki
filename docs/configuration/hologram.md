---
title: 'Hologram'
description: 'Example of a Hologram file'
---
...
The content of the hologram line. See the [Line Content](../features/line-content.md) page for available options.
...
Contains the individual [Click Types](../features/actions.md#click-types) that can be set to perform specific actions.

#### `pages[*].actions.RIGHT`

Contains the individual [Actions](../features/actions.md) that should be performed when right-clicking the Hologram. Actions are executed in order.

#### `pages[*].actions.SHIFT_RIGHT`

Contains the individual [Actions](../features/actions.md) that should be performed when right-clicking the Hologram while sneaking. Actions are executed in order.

#### `pages[*].actions.LEFT`

Contains the individual [Actions](../features/actions.md) that should be performed when left-clicking the Hologram. Actions are executed in order.

#### `pages[*].actions.SHIFT_LEFT`

Contains the individual [Actions](../features/actions.md) that should be performed when left-clicking the Hologram while sneaking. Actions are executed in order.