...
description: 'How to make and use custom Animations'
---
...
Custom Animations can be used through the same format as [built-in animations](index.md):
...
Allows [Formatting and Color codes](../line-content.md#colors-and-formatting) and also Placeholders, if `allow-placeholders-inside-animations` is enabled.
